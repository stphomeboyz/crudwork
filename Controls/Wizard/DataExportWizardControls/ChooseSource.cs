...
namespace crudwork.Controls.Wizard.DataExportWizardControls
{
	...
	/// </summary>
	public partial class ChooseSource : UserControl, IWizardControl
	{
		/// <summary>
		...
		private void ChooseSource_Load(object sender, EventArgs e)
		{
			lblDescription.Text = "Choose the Source";
		}
		...
		{
			return string.Format("Source      = " + DatabaseConnection);
		}
