...
namespace crudwork.Controls.Wizard.PivotTableWizardControls
{
	internal partial class Introduction : UserControl, IWizardControl
	{
		...
		{
			lblDescription.Text = "";
			lblIntroduction.Text = @"This wizard helps you choose an input data file or database, map the required data columns, and pivot the data according to your needs.";
		}
