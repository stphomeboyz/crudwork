namespace crudwork.Controls
{
	partial class InputBox
	{
		...
		private void InitializeComponent()
		{
			...
			this.btnOkay.Location = new System.Drawing.Point(412, 12);
			...
			this.label1.Text = "Enter input on the text below.";
			// 
			// txtInput
			// 
			this.txtInput.Location = new System.Drawing.Point(13, 43);
